...
f"\( V = {cif['_cell_volume']} \)~\AA{{}}\\textsuperscript{{3}}, "
f"\( Z = {cif['_cell_formula_units_Z']} \), "  
f"\( T = {cif['_diffrn_ambient_temperature']}\)~K, "
f"\( \mu ( {radiation[cif['_diffrn_radiation_type']]} ) = {cif['_exptl_absorpt_coefficient_mu']}\)~mm\\textsuperscript{{-1}}, "
f"\( D_{{calc}} = {cif['_exptl_crystal_density_diffrn']}\)~g/cm\\textsuperscript{{3}}, "
